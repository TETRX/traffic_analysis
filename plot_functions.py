...
def basic_plot(G, node_weights, title, path=None):
    ...
    ox.plot_graph(G, node_color=color_map, node_size=node_size, figsize=(55, 55), show=False, save=True, filepath=path)
    if path:
        plt.savefig(path)
    plt.show()
